...
namespace AgenticHrmApi.Migrations
{
    ...
    [Migration("20260902123311_AddUpdatedAtToFaceTemplate")]
    partial class AddUpdatedAtToFaceTemplate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgenticHrmApi.Models.FaceChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AgenticHrmApi.Models.FaceLoginAttempt", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("ChallengeActions")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("FaceLoginAttempts");
                });

            modelBuilder.Entity("AgenticHrmApi.Models.FaceTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AgenticHrmApi.Models.FaceTemplate", b =>
                {
                    b.HasOne("AgenticHrmApi.Models.User", null)
                        .WithMany()
